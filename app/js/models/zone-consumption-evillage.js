(function() {
  ...
  var model = Application.modelFactory('zone-consumption-evillage')
  ...
  model.model_update = function (resolve, reject) {
    $.get(Application.Env.get('backend_url')+'/zoneenergyconsumption/evillage')
      .done(function(result) {
        console.info("Updating zone-consumption-evillage: "+result.time, result)
  ...
  Application.models.ZoneConsumptionEvillage = model
