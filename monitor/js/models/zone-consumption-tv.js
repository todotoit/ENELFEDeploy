(function() {
  ...
  var model = Application.modelFactory('zone-consumption-tv')
  ...
  model.model_update = function (resolve, reject) {
    $.get(Application.Env.get('backend_url')+'/zoneenergyconsumption/tv_compound')
      .done(function(result) {
        console.info("Updating zone-consumption-tv: "+result.time, result)
  ...
  Application.models.ZoneConsumptionTv = model
