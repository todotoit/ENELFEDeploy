(function() {
  ...
  var model = Application.modelFactory('zone-consumption-esports')
  ...
  model.model_update = function (resolve, reject) {
    $.get(Application.Env.get('backend_url')+'/zoneenergyconsumption/esports')
      .done(function(result) {
        console.info("Updating zone-consumption-esports: "+result.time, result)
  ...
  Application.models.ZoneConsumptionEsports = model
